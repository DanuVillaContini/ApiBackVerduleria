...
CREATE TABLE IF NOT EXISTS ventas (
    num_venta INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    clientes_id INT(8) NOT NULL,
    total DECIMAL(10,2) NOT NULL,
    FOREIGN KEY (clientes_id) REFERENCES clientes(id)
);
CREATE TABLE IF NOT EXISTS pedidos (
    num_pedido INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    clientes_id INT(8) NOT NULL,
    total DECIMAL(10,2) NOT NULL,
    FOREIGN KEY (clientes_id) REFERENCES clientes(id)
);
CREATE TABLE IF NOT EXISTS acreedores (
    num_acree INT(8) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    clientes_id INT(8) NOT NULL,
    num_venta INT(8) NOT NULL,
...
INSERT INTO acreedores (clientes_id, num_venta, total_deudor) VALUES
(3, 1, 30.00),
(1, 2, 50.50),
(2, 3, 25.75);
